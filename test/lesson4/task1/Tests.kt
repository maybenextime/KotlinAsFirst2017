...
class Tests {
    ...
    @Tag("Normal")
    fun factorize() {
        assertEquals(listOf(2, 11), factorize(22))
    ...
    @Tag("Hard")
    fun roman() {
        assertEquals("MMMMMMMMMMMMMMDCCCXLVII", roman(14847))
    ...
    @Tag("Impossible")
    fun russian() {
        assertEquals("семьсот одна тысяча семьсот пятьдесят пять", russian(701755))
